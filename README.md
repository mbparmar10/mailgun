...
[![Total Downloads](https://poser.pugx.org/mbparmar10/mailgun/downloads.png)](https://packagist.org/packages/mbparmar10/mailgun)
[![Monthly Downloads](https://poser.pugx.org/mbparmar10/mailgun/d/monthly.png)](https://packagist.org/packages/mbparmar10/mailgun)
[![License](https://poser.pugx.org/mbparmar10/mailgun/license)](https://packagist.org/packages/mbparmar10/mailgun)
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Mbparmar10/Mailgun?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)
...
For older versions of Laravel please refer to [older versions](https://github.com/Mbparmar10/Mailgun/releases) of this package.
...
```bash
composer require mbparmar10/mailgun
```
...
'providers' => [
    ...
    Mbparmar10\Mailgun\MailgunServiceProvider::class
...
'aliases' => [
	...
    'Mailgun' => Mbparmar10\Mailgun\Facades\Mailgun::class
],
```
...
```bash
php artisan vendor:publish --provider="Mbparmar10\Mailgun\MailgunServiceProvider" --tag="config"
```
...
```php
use Mbparmar10\Mailgun\Mail\Message;
...
The Mailgun service is registered in the Container as `mailgun` but you can also use the Interface `Mbparmar10\Mailgun\Contracts\Mailgun` for dependency injection in your app.
...
class CustomController extends Controller
{
    ...
    /**
     * @var \Mbparmar10\Mailgun\Contracts\Mailgun
     */
    protected $mailgun;

    /**
     * @param \Mbparmar10\Mailgun\Contracts\Mailgun $mailgun
     */
    public function __construct(\Mbparmar10\Mailgun\Contracts\Mailgun $mailgun)
    {
