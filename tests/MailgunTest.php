...
class MailgunTest extends MailgunTestCase
{
    ...
    {
        $provides = (new Mbparmar10\Mailgun\MailgunServiceProvider($this->app))->provides();
        $this->assertEquals([
            'mailgun',
            'mailgun.public',
            Mbparmar10\Mailgun\Contracts\Mailgun::class
        ], $provides);
    }
    ...
    public function it_registers_the_mailgun_service()
    {
        ...
        $this->assertInstanceOf(Mbparmar10\Mailgun\Service::class, $service);
    }
    ...
    {
        $service = $this->app->make(Mbparmar10\Mailgun\Contracts\Mailgun::class);
        $this->assertInstanceOf(Mbparmar10\Mailgun\Service::class, $service);
    }
    ...
    {
        $this->assertInstanceOf(Mbparmar10\Mailgun\Service::class, Mailgun::getFacadeRoot());
    }
