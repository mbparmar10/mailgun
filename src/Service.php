...
namespace Mbparmar10\Mailgun;

use Mbparmar10\Mailgun\Contracts\Mailgun as MailgunContract;
use Mbparmar10\Mailgun\Mail\Mailer;
use Closure;
...
class Service implements MailgunContract
{
    ...
    /**
     * @var \Mbparmar10\Mailgun\Mail\Mailer
     */
    protected $mailer;
     ...
     *
     * @return \Mbparmar10\Mailgun\Validation\Validator
     */
